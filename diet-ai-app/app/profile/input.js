...
export default function ProfileInputScreen() {
  ...
  // 체형 선택 옵션을 정의합니다.
  const bodyTypeOptions = ['마름', '보통', '통통']; // 필요한 경우 더 추가할 수 있습니다.
  ...
  const handleSave = async () => {
    ...
    try {
      // database.js의 setUserInfo 함수를 호출하고, selectedBodyType을 전달합니다.
...
// 스타일 시트 (bodyTypeButton 관련 스타일을 추가합니다.)
